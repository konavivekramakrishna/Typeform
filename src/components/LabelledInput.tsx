  ...
  return (
    <div key={props.id} className="mb-4">
      ...
      <div className="flex items-center">
        ...
        <select
          className="border-2 m-1 border-gray-300 rounded-md mt-1    p-1 text-lg focus:outline-none focus:border-blue-500"
          id={`select-${props.id}`}
          value={props.type}
          onChange={(e) => props.typeHandlerCB(props.id, e.target.value)}
        >
